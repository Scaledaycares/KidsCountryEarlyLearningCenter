...
function startConversation() {
    fetch('https://chatbot-for-kids-country-early-learning-centers.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-kids-country-early-learning-centers.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwGM1JLIIf8pZRNKfEttT1rJAo3VnY7fOIiptZgStJycIUgPwKrdl1hrcs575oPXNQD/exec';
